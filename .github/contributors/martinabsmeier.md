...
folder `.github/contributors/`. The name of the file should be your GitHub
username, with the extension `.md`. For example, the user `example_user` would
create the file `example_user.md`.
...
6. This contributor agreement shall be governed exclusively by German law. Any
   choice of law rules will not apply.

7. Please place an “x” on one of the applicable statements below. Please do NOT
